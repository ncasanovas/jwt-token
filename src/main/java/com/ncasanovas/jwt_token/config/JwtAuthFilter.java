package com.ncasanovas.jwt_token.config;
...
import com.ncasanovas.jwt_token.service.JwtService;
...
public class JwtAuthFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(
    ...
    final boolean isTokenValid = jwtService.isValidToken(jwtToken, user.get());
